...
<div class="container-fluid"> 
  <h2 align="center">{{__('messages.createStudent')}}</h2>
      ...
      <div class="container-fluid">
        ...
        <div class="form-group">
          <!--{!! Form::label('profile_pic', 'Profile picture:', ['class' => 'control-label']) !!}-->
		    <label for="profile_pic" class="control-label">{{__('messages.uploadPicDesc')}}</label>

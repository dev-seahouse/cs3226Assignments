  ...
  public function createStudent(Request $request) {
    ...
    */
    ...
    array_push($students , array(
        ...
        "KATTIS" => $kattis,
        "MC" => 0,
        "MC_COMPONENTS" => array('x.y','x.y','x.y','x.y','x.y','x.y','x.y','x.y','x.y'),
        "TC" => 0,
        "TC_COMPONENTS" => array('xy.z','xy.z'),
        "SPE" => 0,
        "HW" => 0,
        "HW_COMPONENTS" => array('x.y','x.y','x.y','x.y','x.y','x.y','x.y','x.y','x.y','x.y'),
        "BS" => 0,
        "BS_COMPONENTS" => array('x','x','x','x','x','x','x','x','x'),
        "KS" => 0,
        "KS_COMPONENTS" => array('x','x','x','x','x','x','x','x','x','x','x','x'),
        "AC" => 0,
        "AC_COMPONENTS" => array('x','x','x','x','x','x','x','x'),
        "DIL" => 0,
        "SUM" => 0
      ));
